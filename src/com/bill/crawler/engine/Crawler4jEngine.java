 ...
 */
public class Crawler4jEngine {
	private static final Logger logger = LoggerFactory.getLogger(Crawler4jEngine.class);

	private final Parser parser;
	private final PageFetcher pageFetcher;

	public Crawler4jEngine() {
	...
	public static void main(String[] args) {
		Crawler4jEngine downloader = new Crawler4jEngine();
